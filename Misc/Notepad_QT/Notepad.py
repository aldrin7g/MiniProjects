...
class AppDemo(QMainWindow):
    def __init__(self):
        ...
        file_toolbar.setIconSize(QSize(43, 43))
        ...
        edit_toolbar.setIconSize(QSize(43, 43))
    ...
    def update_title(self):
        self.setWindowTitle('{0} - Notepad_(by Aldrin : )'.format(os.path.basename(self.path) if self.path else 'Untitled'))
